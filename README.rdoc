...
Project[http://github.com/ms-ati/rumonade]
Documentation[http://rubydoc.info/gems/rumonade/file/README.rdoc]
...
Using Option, one can transform _possibly_nil_ values in a _functional_ fashion, which can increase clarity and robustness:
...
Note:
* each step of the chained computations are functionally isolated
* the value can notionally _start_ as nil, or _become_ nil during a computation, without effecting other chained computations
